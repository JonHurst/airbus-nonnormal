...
phase it can be very helpful to divide the stack into phases: approach,
landing, stopping, go-around and diversion. Write out a bulletted list
of the tactics you intend to deploy so that you can easily check they
have been actioned once the workload starts to build.
